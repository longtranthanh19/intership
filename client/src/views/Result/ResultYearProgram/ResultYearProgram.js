...
const ResultYearProgram = (props) => {
  ...
  useEffect(() => getResultsWave(year, levelOfTraining), []);
  ...
  let waves = getUnique(results?.map((result) => result.wave));
              ...
              <tr>
                <td>
                  <Link
                    ...
                    to={`/result/${year}/${levelOfTraining}/${wave}`}
...
export default ResultYearProgram;
